...
def _gleam_hex_repository(ctx):
    ...
    ctx.file("BUILD", """# This file is generated by the @rules_gleam//:gleam_hex/repositories.bzl%gleam_hex_repository rule. 
# DO NOT EDIT.
...
def _gleam_hex_repositories_config_impl(ctx):
    ...
    ctx.file("BUILD", """# This file is generated by the @rules_gleam//:gleam_hex/repositories.bzl%gleam_hex_repositories_config rule. 
# DO NOT EDIT.
